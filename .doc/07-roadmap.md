...
| Composite GitHub Action | Built. Released as tag v0.1.0 by the release job on main |
| `hunter init` scaffolding, pre-filled, with a five-job workflow: score, three sync checks, publish to GitHub Pages | Built |
| Three sync checks as separate composite actions | Built. Released with the same tag |
...
|---|---|---|
| Publish to the Marketplace | Installable now from the tag; the Marketplace listing is a visibility decision | [09](09-risks-and-open-items.md) |
